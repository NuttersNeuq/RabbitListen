...
import com.lz.javabean.FormFile;
...
public class HttpRequestUtil {
	...
	public static URLConnection sendGetRequest(String url,Map<String, String> params, Map<String, String> headers) throws IOException {
		...
		if (params != null && !params.isEmpty()) {
			...
			for (Map.Entry<String, String> entry : entrys) {
				buf.append(URLEncoder.encode(entry.getKey())).append("=")
	...
	public static URLConnection sendPostRequest(String url,
		...
		conn.setRequestProperty("Content-Type","application/x-www-form-urlencoded");// 设置Content-Type头，必须的
		conn.setRequestProperty("Content-Length",buf.toString().getBytes("UTF-8").length + "");// 设置Content_Length头，必须的
